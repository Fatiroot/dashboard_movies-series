<?php
   ...
   if (isset($_POST["submit"])) {
     ...
     $sql = "UPDATE `movies` SET `titre`='$titre',`annee_de_sortie`='$annee_de_sortie',`duree`='$duree',`country`='$country',`nombre_des _etoiles`='$nombre_des_etoiles',`categorie_id`='$genre' WHERE id = $id";
   
     $result = mysqli_query($db, $sql);
   
     if ($result) {
       header("Location: ../movies.php?msg=Data updated successfully");
     } else {
