               ...
               <table class="table table-hover text-center">
                  ...
                  <tbody>
                     ...
                     <tr>
                        ...
                        <td>
                           <button class="link-dark " data-bs-toggle="modal" data-bs-target="#editModal<?=$row["id"]?>" ><i class="fa-solid fa-pen-to-square fs-5 " style="color: #efbd0b;"></i></button>
                     ...
                     <?php
                        $idd = $row['id'];
                        $sql1 = "SELECT * FROM `categorie` WHERE `id` = $idd ";
                        $result1 = mysqli_query($db, $sql1);
                          $row1 = mysqli_fetch_assoc($result1);
                        ?>
                     <!-- Modal   edit movie -->
                     <div class="modal fade" id="editModal<?=$idd?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                           <div class="modal-content">
                              <div class="modal-header bg-warning">
                              ...
                              <div class="modal-body">
                                 <form method="post" action="">
                                    <label class="form-label text-white mb-3">Nom</label>
                                    <input type="hidden" class="form-control" name="id" placeholder="Edit categorie" value="<?php echo $row['id'] ?>">
                                    <input type="text" class="form-control" name="genre" placeholder="Edit categorie" value="<?php echo $row['nom'] ?>">
                              </div>
                              <div class="modal-footer bg-warning">
                              <input type="button" class="btn btn-danger" data-bs-dismiss="modal" value='Cancel'>
